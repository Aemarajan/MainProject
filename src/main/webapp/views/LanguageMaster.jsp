...
<div>
				...
				<div class="col col-sm-10 col-md-10 col-lg-10">
					<div class="table-wrapper">
						...
						<div id="addModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="SaveLanguageMaster" method="post" modelAttribute="language">
										...
										<div class="modal-body">
											...
											<c:if test="${addExist != null }">
												<div class="toast" id="Toast">
													...
													<div class="toast-body py-2">
														<div>Language Already Exist, Enter New Language...</div>
													</div>
												</div>
											</c:if>
											...
											<div class="row">
												...
												<div class="col-sm-1 p-0">
													<a href="#" data-toggle="tooltip" data-placement="top" title="Tamil,English"><i class="fa fa-info-circle mt-4"></i></a>
												</div>
											</div>
						...
						<div id="editModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="EditLanguage" method="post" modelAttribute="language">
										<div class="modal-header">						
	...
	<c:if test="${added != null }">
		<div class="toast" id="Toast" 
			...
			<div class="toast-body py-2">
				<div>Language Details are Added Successfully.</div>
			</div>
		</div>
	</c:if>
	...
	<c:if test="${updated != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Language Details are Updated Successfully.</div>
			</div>
		</div>
	</c:if>
	...
	<c:if test="${deleted != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Language Deactivated Successfully.</div>
			</div>
		</div>
	</c:if>
