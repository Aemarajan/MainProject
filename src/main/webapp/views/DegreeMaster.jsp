...
<div>
	...
	<div class="wrpper d-flex align-items-stretch">  
		...
		<div class="container-fluid pl-5">
			<div class="row mt-2 mb-2">
				...
				<div class="col col-md-10 col-md-10 col-md-10">
					
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6">
									<h2>Manage <b>Degree</b></h2>
								</div>
								<div class="col-sm-6">
						...
						<c:url value="/GetDegreeMaster" var="pagedLink">
