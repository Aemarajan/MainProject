...
<title>Country-State-District Mapping</title>
				...
				<div class="col col-sm-10 col-md-10 col-lg-10">
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6">
									<h2>Manage <br>Country State District Mapping</h2>
								</div>
								<div class="col-sm-6">
								...
								<tbody>
									<c:forEach var="l" items="${pagedListHolder.pageList }">
										<tr>
											...
											<td class="text-capitalize">${l.district.name }</td>
											<td>
						...
						<div id="addModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="SaveCSDMapping" method="post" modelAttribute="csdMapping">
