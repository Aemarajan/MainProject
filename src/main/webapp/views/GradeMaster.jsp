									...
									<s:form action="SaveGradeMaster" method="post" modelAttribute="grade">
										...
										<div class="modal-body">
											...
											<div class="mt-2">
						                      ...
						                      <s:select path="regulation" cssClass="browser-default custom-select" id="regulation"/>
								...
								<div class="modal-content">
									<s:form action="EditGrade" method="post" modelAttribute="grade">
										...
										<div class="modal-body">
											...
											<div class="mt-2">
						                      <label class="d-flex justify-content-start">Regulation <span class="mandatory pl-1"> *</span></label>
						                      <s:select path="regulation" cssClass="browser-default custom-select" id="editRegulation"/>
						                      <s:errors path="regulation" cssClass="error" />
						                    </div>
