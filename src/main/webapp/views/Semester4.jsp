			...
			<div class="mt-2 mb-3">
				<nav aria-label="breadcrumb">
					<ol class="breadcrumb indigo lighten-4">
						...
						<li class="breadcrumb-item active">Fourth Semester</li>
					</ol>
				</nav>
			</div>
		
			<h4 class="banner p-2 mt-2 mb-2">Fourth Semester</h4>
			
<%-- 			<s:form action="SaveSemester4" method="post" modelAttribute="external" class="mt-2"> --%>
			<form action="SaveSemester4" method="post" class="mt-2">
