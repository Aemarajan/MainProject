...
<div>
	...
	<div class="wrapper d-flex align-items-stretch">  
		...
		<div class="container-fluid pl-5">
			<div class="row mt-2 mb-2">
				...
				<div class="col col-sm-10 col-md-1 col-lg-10">
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6">
									<h2>Manage <b>Religion Master</b></h2>
								</div>
								<div class="col-sm-6">
						...
						<c:url value="/GetReligionMaster" var="pagedLink">
						...
						<div id="addModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="SaveReligionMaster" method="post" modelAttribute="religion">
										...
										<div class="modal-body">
											...
											<c:if test="${addExist != null }">
												<div class="toast" id="Toast">
													...
													<div class="toast-body py-2">
														<div>Religion Already Exist, Enter New Religion...</div>
													</div>
												</div>
											</c:if>
											...
											<div class="row">
												...
												<div class="col-sm-1 p-0">
													<a href="#" data-toggle="tooltip" data-placement="top" title="Hindu,Christian,Muslim..."><i class="fa fa-info-circle mt-4"></i></a>
												</div>
											</div>
						...
						<div id="editModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="EditReligion" method="post" modelAttribute="religion">
										<div class="modal-header">						
						...
						<div id="deleteModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<form action="DeleteReligion" method="post">
										<div class="modal-header">						
											<h4 class="modal-title">Delete Religion</h4>
											<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
										</div>
										<div class="modal-body">					
	...
	<c:if test="${added != null }">
		<div class="toast" id="Toast" 
			...
			<div class="toast-body py-2">
				<div>Religion Details are Added Successfully.</div>
			</div>
		</div>
	</c:if>
	...
	<c:if test="${updated != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Religion Details are Updated Successfully.</div>
			</div>
		</div>
	</c:if>
	...
	<c:if test="${deleted != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Religion Deactivated Successfully.</div>
			</div>
		</div>
	</c:if>
