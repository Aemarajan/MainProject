...
<%-- 	<jsp:include page="Menubar.jsp" /> --%>
        	...
        	<div class="row mt-2 mb-2">
            	...
            	<div class="col col-sm-10 col-md-10 col-lg-10">
              		<div class="table-wrapper">
						...
						<c:url value="/GetRegulationMaster" var="pagedLink">
									...
									<s:form action="SaveRegulationMaster" method="post" modelAttribute="regulation">
										...
										<div class="modal-body">
											...
											<div class="row">
												<div class="col-sm-11">
													<div class="md-form mt-0">
														<s:input path="acronym" maxlength="5" cssClass="form-control"/>
						...
						<div id="deleteModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<form action="DeleteRegulation" method="post">
										<div class="modal-header">						
    ...
    <c:if test="${added != null }">
		<div class="toast" id="Toast" 
			...
			<div class="toast-body py-2">
				<div>Regulation Details are Added Successfully.</div>
			</div>
		</div>
	</c:if>
	...
	<c:if test="${updated != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Regulation Details are Updated Successfully.</div>
			</div>
		</div>
	</c:if>
	...
	<c:if test="${deleted != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Regulation Deactivated Successfully.</div>
			</div>
		</div>
	</c:if>
