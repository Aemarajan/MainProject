    ...
    <div class="row justify-content-center">
        <div class="col-11 col-sm-9 col-md-7 col-lg-10 col-xl-9 text-center p-0 mt-3 mb-2">
            <div class="card1 px-0 pt-4 pb-0 mt-3 mb-3">
                <h2 id="heading">Fill Up Your Details</h2>
                ...
                <form id="msform">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <h5 class="d-flex justify-content-center">Official Address</h5><hr>
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-3"> <i class="fa fa-check-circle fa-5x"></i> </div>
                            </div> <br><br>
                            <div class="row justify-content-center">
