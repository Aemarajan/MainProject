...
<title>Regulation-Semester-Syllabus Mapping</title>
				...
				<div class="col col-sm-10 col-md-10 col-lg-10">
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6">
									<h2>Regulation Semester Syllabus Mapping</h2>
								</div>
								<div class="col-sm-6">
						...
						<c:url value="/GetRSSMapping" var="pagedLink">
								...
								<tbody>
									<c:forEach var="l" items="${pagedListHolder.pageList }">
										<tr>
											...
											<td>
												<a href="changeStatusInRSS?id=${l.id }" class="delete"><i class="fa fa-exchange-alt" data-toggle="tooltip" title="Change"></i></a>
											</td>
										</tr>
									</c:forEach>
							</tbody>
						...
						<div id="addModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="SaveRSSMapping" method="post" modelAttribute="RSSMapping">
										<div class="modal-header">						
											<h4 class="modal-title">Add RSS Mapping</h4>
	...
	$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(result){
                var output = "<option value='0'> -- Select -- </option>";
                for(var i in result){
                    output+="<option value="+result[i].id+">"+result[i].subject_code+"</option>";
                }
                console.log(output);
                subject.html(output);
            }
