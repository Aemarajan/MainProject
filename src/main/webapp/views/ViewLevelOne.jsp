...
<%-- 	<jsp:include page="Menubar.jsp" /> --%>
				...
				<div class="col col-sm-10 col-md-10 col-lg-10">
					<div class="table-wrapper">
						<div class="table-title">
							<div class="row">
								<div class="col-sm-6">
									<h2>Manage <b>Level One data</b></h2>
								</div>
								<div class="col-sm-6">						
								</div>
							</div>
						...
						<c:url value="/ViewLevelOne" var="pagedLink">
							...
							<thead>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="#editModal" class="edit" data-toggle="modal" data-lvl1_id="${l.lvl1_id }" data-name="${l.name }" data-dd="${l.dd }" data-inn="${l.inn }"><i class="fa fa-pencil-alt" data-toggle="tooltip" title="Edit"></i></a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
						...
						<div id="editModal" class="modal fade">
							<div class="modal-dialog">
								<div class="modal-content">
									<s:form action="EditLevelOne" method="post" modelAttribute="ValidateLevelOne">
										<div class="modal-header">						
											<h4 class="modal-title">Edit Level One Data</h4>
	...
	<c:if test="${updated != null }">
		<div class="toast" id="Toast"
			...
			<div class="toast-body py-2">
				<div>Level One Details are Updated Successfully.</div>
			</div>
		</div>
	</c:if>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#editModal').on('show.bs.modal', function (event) {
			...
			var lvl1_id = button.data('lvl1_id');
			var name = button.data('name'); 
			var dd = button.data('dd'); 
			var inn = button.data('inn');

			var modal = $(this);
			modal.find('#lvl1_id').val(lvl1_id);
