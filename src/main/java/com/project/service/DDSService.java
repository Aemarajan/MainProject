...
public class DDSService {
	...
	public List<DDSMapping> checkDDSCombo(int batch, int regulation, int degree, int department, int year, int semester,
			int section) {
		return ddsRepo.findDDSCombo(batch,regulation,degree,department,year,semester,section);
	}
